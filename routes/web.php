...
Route::view('/categoryPage','pages.dashboard.category-page');//->middleware('auth:sanctum');
Route::view('/customerPage','pages.dashboard.customer-page');//->middleware('auth:sanctum');
Route::view('/customerPage','pages.dashboard.customer-page');//->middleware('auth:sanctum');
Route::view('/productPage','pages.dashboard.product-page');//->middleware('auth:sanctum');

Route::view('/invoicePage','pages.dashboard.invoice-page');//->middleware('auth:sanctum');
Route::view('/salePage','pages.dashboard.sale-page');//->middleware('auth:sanctum');
Route::view('/reportPage','pages.dashboard.report-page');//->middleware('auth:sanctum');
